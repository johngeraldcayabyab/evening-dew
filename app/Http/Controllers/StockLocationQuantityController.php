...
class StockLocationQuantityController extends Controller
{
    ...
    public function index(Request $request): ResourceCollection
    {
        ...
        $stockLocationQuantity = StockMovement::selectRaw("COUNT(stock_movements.product_id) as product_aggregate, COUNT(stock_movements.destination_location_id) as location_aggregate, products.name as product_name, locations.name as location_name, $rawQuery")
