...
class SalesOrderRoute
{
    public static function initialize()
    {
        Route::middleware('auth:sanctum')->group(function () {
            ...
            Route::get('sales_orders/{sale_order}/slug', [SalesOrderController::class, 'slug'])->name('sales_orders.slug');
            Route::get('sales_orders/{sale_order}', [SalesOrderController::class, 'show'])->name('sales_orders.show');
            Route::put('sales_orders/{sale_order}', [SalesOrderController::class, 'update'])->name('sales_orders.update');
            Route::delete('sales_orders/{sale_order}', [SalesOrderController::class, 'destroy'])->name('sales_orders.destroy');
