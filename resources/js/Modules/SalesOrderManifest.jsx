...
const manifest = {
    ...
    table: {
        columnSelection: true, columns: [{
            ...
            sorter: true,
            filter: SEARCH,
            booleanTagRender: [{color: 'processing', label: 'Draft', value: 'draft'}, {
            ...
            title: 'Shipping date', dataIndex: 'shipping_date', key: 'shipping_date', sorter: true, filter: DATE_RANGE,
        }, {
    ...
    form: {
        initialValue: true, row_1: {
            ...
            defaultActiveKey: 'tab_pane_1', tab_pane_1: {
                name: "Order Lines", form_line_1: {
                ...
                name: "Other Information", row_1: {
                    ...
                    col_1: [{
                        ...
                        type: 'select', name: 'source_id', label: 'Source', query: {url: '/api/sources', field: 'name'},
                    },]
                }, row_3: {
                    col_1: [{
