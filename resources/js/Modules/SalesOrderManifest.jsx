...
import {DATE_RANGE, GET, HAS_FORM_CLONE, HAS_FORM_CREATE, HAS_FORM_UPDATE, HAS_TABLE, SEARCH} from "../consts";
...
const manifest = {
    ...
    queryDefaults: {},
    routes: [HAS_FORM_CREATE, HAS_FORM_UPDATE, HAS_TABLE, HAS_FORM_CLONE],
    table: {
