...
use App\Http\Controllers\DeliveryFeeLineController;
use App\Http\Controllers\GlobalSettingController;
use App\Http\Controllers\LocationController;
use App\Http\Controllers\LoginController;
use App\Http\Controllers\MaterialController;
use App\Http\Controllers\MaterialLineController;
...
Route::group(['middleware' => ['api', 'cors']], function () {
    ...
    (new RouteGenerator(DeliveryFeeLine::class))::generate(DeliveryFeeLineController::class);
    ...
    (new RouteGenerator(MaterialLine::class))::generate(MaterialLineController::class);
