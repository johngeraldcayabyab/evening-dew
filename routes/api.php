...
$middleware = ['api', 'cors', 'auth:sanctum'];
new ProductRoute($middleware, 'products');
new CityRoute($middleware, 'cities');
new SalesOrderRoute($middleware, 'sales_orders');
new UserRoute($middleware, 'users');
new MeasurementRoute($middleware, 'measurements');
